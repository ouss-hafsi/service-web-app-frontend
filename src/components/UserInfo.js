...
const UserInfo = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://service-web-app-backend.onrender.com/users/${id}`)
      .then((res) => {
  ...
  function handleSubmit(event) {
    ...
    axios.put(`https://service-web-app-backend.onrender.com/users/${id}`, userInfo)
    .then(() => {
  ...
  function handleDelete() {
    axios.delete(`https://service-web-app-backend.onrender.com/users/${id}`)
    .then(() => {
